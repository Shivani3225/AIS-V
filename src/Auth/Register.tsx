...
//     // Replace the case 3 (Business Hours) section in renderStepContent with this:
...
//                 >
//                   <FeatherIcon name="clock" size={20} color="#8B5CF6" />
//                 </TouchableOpacity>
//               </View>
//             </View>
...
//               onConfirm={(time) => setOpeningTime(time)}
...
//               onConfirm={(time) => setClosingTime(time)}
...
const TimePickerModal = ({ visible, onClose, onConfirm, currentTime, title }) => {
  ...
  useEffect(() => {
    if (currentTime) {
      const match = currentTime.match(/(\d{2}):(\d{2})\s(AM|PM)/);
      if (match) {
  ...
  return (
    ...
    >
      <View style={localStyles.modalOverlay}>
        <View style={localStyles.timePickerModalContent}>
          <View style={localStyles.timePickerHeader}>
            <Text style={localStyles.timePickerTitle}>{title}</Text>
            <TouchableOpacity onPress={onClose}>
              <FeatherIcon name="x" size={24} color="#6B7280" />
            </TouchableOpacity>
          </View>

          <View style={localStyles.timePickerBody}>
            <View style={localStyles.timePickerColumn}>
              <Text style={localStyles.timePickerColumnLabel}>Hour</Text>
              <FlatList
                data={hours}
                ...
                renderItem={({ item }) => (
                  <TouchableOpacity
                    style={[
                      ...
                      selectedHour === item && localStyles.timePickerItemSelected
                    ]}
                    onPress={() => setSelectedHour(item)}
                  >
                    <Text style={[
                      localStyles.timePickerItemText,
                      selectedHour === item && localStyles.timePickerItemTextSelected
                    ]}>{item}</Text>
                  </TouchableOpacity>
                )}
              />
            ...
            <View style={localStyles.timePickerColumn}>
              <Text style={localStyles.timePickerColumnLabel}>Minute</Text>
              <FlatList
                data={minutes}
                keyExtractor={(item) => item}
                showsVerticalScrollIndicator={true}
                ...
                renderItem={({ item }) => (
                  <TouchableOpacity
                    style={[
                      localStyles.timePickerItem,
                      selectedMinute === item && localStyles.timePickerItemSelected
                    ]}
                    onPress={() => setSelectedMinute(item)}
                  >
                    <Text style={[
                      localStyles.timePickerItemText,
                      selectedMinute === item && localStyles.timePickerItemTextSelected
                    ]}>{item}</Text>
                  </TouchableOpacity>
                )}
              />
            ...
            <View style={localStyles.timePickerColumn}>
              <Text style={localStyles.timePickerColumnLabel}>Period</Text>
              <FlatList
                data={periods}
                keyExtractor={(item) => item}
                showsVerticalScrollIndicator={true}
                ...
                renderItem={({ item }) => (
                  <TouchableOpacity
                    style={[
                      localStyles.timePickerItem,
                      selectedPeriod === item && localStyles.timePickerItemSelected
                    ]}
                    onPress={() => setSelectedPeriod(item)}
                  >
                    <Text style={[
                      localStyles.timePickerItemText,
                      selectedPeriod === item && localStyles.timePickerItemTextSelected
                    ]}>{item}</Text>
                  </TouchableOpacity>
                )}
              />
          ...
          <View style={localStyles.timePickerFooter}>
            <TouchableOpacity style={localStyles.timePickerCancelBtn} onPress={onClose}>
              <Text style={localStyles.timePickerCancelText}>Cancel</Text>
            </TouchableOpacity>
            <TouchableOpacity style={localStyles.timePickerConfirmBtn} onPress={handleConfirm}>
              <Text style={localStyles.timePickerConfirmText}>Confirm</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
        ...
        return (
          <View style={styles.stepContent}>
            ...
            <View style={localStyles.timeSection}>
              <View style={localStyles.timeLabelContainer}>
                <Text style={localStyles.timeLabel}>Opening Time</Text>
              </View>
              <View style={localStyles.timePickerBox}>
                <Text style={localStyles.timePickerText}>{openingTime}</Text>
                <TouchableOpacity 
                  onPress={() => setShowOpeningTimePicker(true)}
                  style={localStyles.clockIconButton}
                >
                  <FeatherIcon name="clock" size={20} color="#8B5CF6" />
                </TouchableOpacity>
              </View>
            ...
            <View style={localStyles.timeSection}>
              <View style={localStyles.timeLabelContainer}>
                <Text style={localStyles.timeLabel}>Closing Time</Text>
              </View>
              <View style={localStyles.timePickerBox}>
                <Text style={localStyles.timePickerText}>{closingTime}</Text>
                <TouchableOpacity 
                  onPress={() => setShowClosingTimePicker(true)}
                  style={localStyles.clockIconButton}
                >
